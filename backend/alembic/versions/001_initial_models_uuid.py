...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('role', postgresql.ENUM('superadmin', 'gerente', 'operador', 'repartidor', name='userrole', create_type=False), nullable=False),
    ...
    op.create_table('riders',
        ...
        sa.Column('vehicle_type', postgresql.ENUM('moto', 'bicicleta', 'auto', 'pie', name='vehicletype', create_type=False), nullable=False, default='moto'),
        ...
        sa.Column('status', postgresql.ENUM('pendiente', 'activo', 'inactivo', 'suspendido', name='riderstatus', create_type=False), nullable=False, default='pendiente'),
    ...
    op.create_table('orders',
        ...
        sa.Column('status', postgresql.ENUM('pendiente', 'asignado', 'en_recoleccion', 'recolectado', 'en_ruta', 'entregado', 'fallido', 'cancelado', name='orderstatus', create_type=False), nullable=True),
    ...
    op.create_table('deliveries',
        ...
        sa.Column('status', postgresql.ENUM('pendiente', 'iniciada', 'en_route', 'completada', name='deliverystatus', create_type=False), nullable=True, default='pendiente'),
        sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=False, server_default=sa.func.now()),
    ...
    op.create_table('shifts',
        ...
        sa.Column('status', postgresql.ENUM('activo', 'cerrado', name='shiftstatus', create_type=False), nullable=False, default='activo'),
    ...
    op.create_table('notifications',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('type', postgresql.ENUM('push', 'email', 'sms', 'in_app', name='notificationtype', create_type=False), nullable=False, default='in_app'),
